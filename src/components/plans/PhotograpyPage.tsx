...
export default function PhotograpyPage() {
  ...
  const service = {
    ...
    imagen: 'https://res.cloudinary.com/dmq5jbp3z/image/upload/v1762383404/photo-1751107996106-ab89608a49b7_fakdgp.jpg',
    items: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-[50%_40%] gap-8 justify-center items-center">
          <div className="order-2 md:order-1">
            <div className="max-w-[640px] md:ml-auto justify-start mr-2">
              <p className="text-sm text-zinc-700 leading-relaxed mb-6">{service.descripcion}</p>
