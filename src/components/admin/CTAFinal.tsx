...
export default function AdminCTAFinal() {
      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        >
          ...
          <H2 className="mx-auto max-w-3xl text-3xl leading-tight tracking-normal text-[#2f3a35] md:text-5xl">
            ¿Listo para dejar tu propiedad en <em className="font-medium italic text-[#52655B]">buenas manos</em>?
          </H2>
          ...
          <P className="mx-auto mt-6 max-w-2xl text-sm leading-7 text-[#4b5c54] md:text-lg">
            Contáctanos y te explicamos cuál plan se adapta mejor a tu propiedad y objetivos. Sin compromiso.
          </P>

          <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:items-center sm:justify-center md:mt-10 md:gap-4">
            <a
              href="https://wa.me/50683888231"
              target="_blank"
              rel="noopener noreferrer"
              className="group relative inline-flex w-fit self-center items-center justify-center gap-2 rounded-full border border-[#52655B] bg-[#52655B] px-4 py-2.5 text-xs font-semibold text-white shadow-[0_14px_28px_rgba(82,101,91,0.35)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#3f4f47] hover:shadow-[0_18px_32px_rgba(82,101,91,0.45)] md:gap-3 md:px-8 md:py-4 md:text-base"
            >
              ...
              <span className="relative inline-flex h-7 w-7 items-center justify-center rounded-full bg-white/15 transition-transform duration-300 group-hover:translate-x-1 md:h-8 md:w-8">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 24 24"
