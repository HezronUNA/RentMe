...
export default function AccomodationsMobile({ hospedajes }: Props) {
  return (
    <>
      {/* Carrusel con scroll-snap centrado */}
      <div
        className="
          relative w-full overflow-x-auto snap-x snap-mandatory
          px-[7vw]  /* centra el primer/último slide (86vw => (100-86)/2) */
        "
        style={{
      ...
      <div className="mt-4 flex justify-center">
        <Button variant="green"><Link to="/alojamientos">Ver más propiedades</Link></Button>
      </div>
    </>
  )
}
