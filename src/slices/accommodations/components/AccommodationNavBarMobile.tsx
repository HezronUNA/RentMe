...
interface AccommodationNavBarMobileProps {
  accommodationName?: string
}

export function AccommodationNavBarMobile({ accommodationName = "Alojamiento" }: AccommodationNavBarMobileProps) {
        ...
        <nav className="flex-1 overflow-y-auto px-5 py-2">
          {SECTIONS.map((section) => (
            <button
              ...
              className="
                w-full text-left py-3 px-3 rounded-lg text-[15px] font-medium
                text-gray-800 hover:bg-[#52655B]/10 hover:text-[#52655B]
                transition-colors border-b border-gray-100
                focus:outline-none focus:ring-2 focus:ring-[#52655B]/50
              "
            >
              {section.label}
            </button>
