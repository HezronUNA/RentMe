...
export function AirbnbIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" width={size} height={size} className={className} {...props}>
      <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 18c-4.4 0-8-3.6-8-8s3.6-8 8-8 8 3.6 8 8-3.6 8-8 8zm3.5-6.6c-.3.8-1.2 1.6-1.2 1.6s-.6.5-1 .8c-.3.2-.6.4-1 .6-.1.1-.3.1-.4.1-.1 0-.3 0-.4-.1-.4-.2-.7-.4-1-.6-.4-.3-1-.8-1-.8s-.9-.8-1.2-1.6c-.3-.7-.3-1.5 0-2.2.3-.8 1.2-1.6 1.2-1.6s.6-.5 1-.8c.3-.2.6-.4 1-.6.1-.1.3-.1.4-.1.1 0 .3 0 .4.1.4.2.7.4 1 .6.4.3 1 .8 1 .8s.9.8 1.2 1.6c.3.7.3 1.5 0 2.2zM12 9c-1.7 0-3 1.3-3 3s1.3 3 3 3 3-1.3 3-3-1.3-3-3-3z" />
    </svg>
  )
}
